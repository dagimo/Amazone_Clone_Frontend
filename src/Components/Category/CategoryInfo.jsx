...
import CategoryCard from './CategoryCard'; // Assuming CategoryCard is in the same directory
import classes from './category.module.css'; // Assuming you want to apply some styling to the container
